		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                            ...
                            <table width="945" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td height="45"><div align="center" class="FormCommonRequired style2"><strong> STAFF MEMBERS </strong></div></td>
                              </tr>
                              <tr>
                                <td><br>
...
?>
                                    ...
                                    <tr>
                                      ...
                                      <td width="90" bgcolor="#62A6E3"><span class="style1">Username</span></td>
                                      <td width="90" bgcolor="#62A6E3"><span class="style1">Email</span></td>
                                      <td width="90" bgcolor="#62A6E3"><span class="style1">Usertype</span></td>
                                      <td width="90" bgcolor="#62A6E3"><span class="style1">Action</span></td>
                                       </tr>
                                    <?php
								...
								while($rows=mysql_fetch_array($result)){
                                    ...
                                    <tr>
                                      ...
                                      <td bgcolor="#FFFFFF"><?php echo $rows['usertype']; ?></td>
                                        <td bgcolor="#FFFFFF">  <a href="edit-user.php?uid=<?php echo $rows['ID']?>">Edit User</a> </td>
