		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                            ...
                            <table width="945" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td height="45"><div align="center" class="FormCommonRequired style2"><strong>REGISTRATION REPORT</strong></div></td>
                              </tr>
                              <tr>
                                <td><br>
								...
								while($rows=mysql_fetch_array($result)){
                                    ...
                                    <tr>
                                      ...
                                      <td bgcolor="#FFFFFF"><?php echo $rows['tel']; ?></td>
                                       <td bgcolor="#FFFFFF"><?php echo number_format($rows['amt'],0); ?></td>
                                    ...
                                    <tr>
                                      <td colspan="11" bgcolor="#FFFFFF"><div align="center">
                                        <blockquote>
                                          <p><a href="admin.php"><strong> back</strong></a>| <a href="#" onClick="PrintDoc('printarea');">Print</a></p>
