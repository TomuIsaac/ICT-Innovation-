		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                            ...
                            <table width="945" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td height="45"><div align="center" class="style3">REGISTRAR'S PANEL</div></td>
                              </tr>
                              <tr>
                                <td><br>
...
?>
								...
								while($rows=mysql_fetch_array($result)){
                                    ...
                                    <tr>
                                      ...
                                      <td bgcolor="#FFFFFF"><table width="200" border="0"><tr><td><table width="200" border="0">
                                        <tr>
                                          <td><a href="payr.php">.Check payment</a></td>
                                        </tr>
                                        <tr>
                                          <td><a href="sms.php">.View applicant messages and seed feeback</a></td>
                                        </tr>
                                        <tr>
                                          <td>&nbsp;</td>
                                        </tr>
                                      </table>                                        <a href="payr.php"></a></td>
                                        </tr>
                                      </table>                                        
                                      <a href="sms.php"></a></td>
                                    </tr>
