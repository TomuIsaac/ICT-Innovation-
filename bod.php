...
<title>Out-patient support  management system</title>
                              ...
                              <tr>
                                <td height="93"><br>
                                  <table width="499" height="68" border="0" align="center" cellpadding="4" cellspacing="1">
                                    <tr>
                                      <td width="238" height="52" background="config/images/bgb.png"><table width="424" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#C3C3C3">
                                        <tr>
...
VALUES ('$pid', '$dat','$name', '$co', '$email', '$tel', '$amt', '$com', '$appro')";
...
echo "<meta http-equiv=Refresh content=3;url=approve.php>";
