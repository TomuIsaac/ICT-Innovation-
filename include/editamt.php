...
$result = mysql_query("SELECT * FROM pay WHERE pid  = '$id'");
...
{	
	...
	mysql_query("UPDATE pay SET name ='$name_save', co ='$co_save',
		 email ='$email_save',tel ='$tel_save', amt = '$amt_save' WHERE pid = '$id'")
				or die(mysql_error()); 
	echo "Saved!";
	
	header("Location: editamtv.php");			
}
mysql_close();
?>
                                ...
                                <td><div align="center"><a href="index.php">Logout</a><br>
                                  ...
                                  <table width="319" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#62A6E3">
                                    ...
                                    <tr>
                                      ...
                                      <td bgcolor="#FFFFFF"><div align="center"><strong>:</strong></div></td>
                                      <td bgcolor="#FFFFFF"><input name="amt" type="text" value="<?php echo $amt; ?>" size="40"  /></td>
                                    </tr>
                                    <tr>
                                  ...
                                  <p align="center"><a href="editamtv.php">back</a></p>
                                </table>
              <p style="margin-top: 0pt; margin-bottom: 0pt;" align="center">&nbsp;</p></td>
              </tr>
			<tr>
