...
$sql="select * from pay where pid='$pid'";
                            ...
                            <table width="945" border="0" align="center" cellpadding="0" cellspacing="0">
                              ...
                              <tr>
                                <td><div align="center"><a href="index.php">Logout</a><br>
                                  ...
                                  <form name="myform" method="post" action="register2.php">
                                  <p>&nbsp;</p>
                                  <table width="319" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#62A6E3">
                                    ...
                                    <tr>
                                      ...
                                      <td bgcolor="#FFFFFF"><div align="center"><strong>:</strong></div></td>
                                      <td bgcolor="#FFFFFF"><input name="com" type="text" id="com" /></td>
                                    </tr>
                                    <tr>
                              ...
                              <tr>
                                <td><div align="center">
                                  <div align="center"><a href="payr.php">back</a><br>
                                  </div>
                                </div></td>
                              </tr>
                              <tr>
...
//You should create the validator only after the definition of the HTML form
  ...
  frmvalidator.addValidation("com","req","Please enter company name");
