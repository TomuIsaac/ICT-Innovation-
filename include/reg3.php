		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                            ...
                            <table width="945" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td height="45"><div align="center" class="FormCommonRequired style2"><strong>ADMINISTRATORT'S REPORT</strong></div></td>
                              </tr>
                              <tr>
                                <td><br>
...
?>
                                    ...
                                    <tr>
                                      ...
                                      <td width="90" bgcolor="#62A6E3"><span class="style1">Date</span></td>
                                      <td width="90" bgcolor="#62A6E3"><span class="style1">Personal/Group Name</span></td>
                                      <td width="90" bgcolor="#62A6E3"><span class="style1">Company Type</span></td>
                                      <td width="90" bgcolor="#62A6E3"><span class="style1">Register Company Name</span></td>
                                      <td width="90" bgcolor="#62A6E3"><span class="style1">Email Address</span></td>
                                      <td width="90" bgcolor="#62A6E3"><span class="style1">Tel.No</span></td>
                                      <td width="90" bgcolor="#62A6E3"><span class="style1">Amount</span></td>
                                      <td width="90" bgcolor="#62A6E3"><span class="style1">Approved</span></td>
                                       </tr>
                                    <?php
								...
								while($rows=mysql_fetch_array($result)){
                                    ...
                                    <tr>
                                      <td colspan="11" bgcolor="#FFFFFF"><div align="center">
                                        <blockquote>
                                          <p><a href="admin.php"><strong> back</strong></a></p>
                                        </blockquote>
                                      </div></td>
                                    </tr>
                                  </table></td>
